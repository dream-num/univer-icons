...
> Univer icons are published as React and Vue component packages for office software scenarios.
...
We have established a build pipeline using SVGO and tsdown to optimize the initial icon resources, generate corresponding React components, and emit distributable ESM/CJS packages.
